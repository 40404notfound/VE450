...
typedef enum mach_attr {
  MACH_BASE, MACH_RISCV_RV64, MACH_MAX
} MACH_ATTR;
...
typedef enum ifield_type {
  RISCV_F_NIL, RISCV_F_ANYOF, RISCV_F_OPCODE, RISCV_F_RD
 , RISCV_F_FUNCT3, RISCV_F_IMM12_3112, RISCV_F_MAX
} IFIELD_TYPE;
...
typedef enum cgen_hw_type {
 ...
 , HW_H_IADDR, HW_H_PC, HW_H_GPR, HW_MAX
} CGEN_HW_TYPE;
...
typedef enum cgen_operand_type {
  RISCV_OPERAND_PC, RISCV_OPERAND_RD, RISCV_OPERAND_RS1, RISCV_OPERAND_IMM_LO12
 , RISCV_OPERAND_MAX
} CGEN_OPERAND_TYPE;
