			   ...
			   CGEN_FIELDS * fields)
{
  ...
  switch (opindex)
    ...
    case RISCV_OPERAND_IMM_LO12 :
      errmsg = cgen_parse_signed_integer (cd, strp, RISCV_OPERAND_IMM_LO12, (long *) (& fields->f_imm12_3112));
      break;
    case RISCV_OPERAND_RD :
      errmsg = cgen_parse_keyword (cd, strp, & riscv_cgen_opval_h_gpr, & fields->f_rd);
      break;
